...
import dubbo.common.utils.ClassHelper;
import dubbo.common.utils.IOUtils;
...
public final class ClassGenerator
{
   ...
   public  void debugCode( CtClass clazz){
	   try {
		File file = new File("c:/myjava");
		if(!file.exists()){
			file.createNewFile();
		}
		clazz.writeFile(file.getAbsolutePath());
		file.deleteOnExit();
	} catch (IOException e) {
		e.printStackTrace();
	} catch (CannotCompileException e) {
